...
it(
    ...
    withSnapshotDefault('async-call-batch-notify-1', async (f, _, log) => {
        const server = f()
...
it(
    ...
    withSnapshotDefault('async-call-batch-notify-2', async (f, _, log) => {
        const server = f()
...
it(
    ...
    withSnapshotDefault('async-call-batch-notify-3', async (f, _, log) => {
        const server = f()
